...
import com.example.jetfurniture.data.popularProductList
import com.example.jetfurniture.navigation.Checkout
import com.example.jetfurniture.ui.theme.Background_1
import com.example.jetfurniture.ui.theme.DarkOrange
import com.example.jetfurniture.ui.theme.GrayColor
import com.example.jetfurniture.ui.theme.LightGray_1
import com.example.jetfurniture.ui.theme.LightOrange
...
fun ProductScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()){
        ...
        Box(modifier = Modifier
                ...
                item {
                    ...
                    Row {
                        chips.forEachIndexed { index, s ->
                            CustomChips(title = s, selected = index==selected, index =index, onValueChange ={
                                selected=it
                            })
                        }
                    }
                    Spacer(modifier = Modifier.height(10.dp))
                    Text(text = stringResource(id = R.string.lorem_ipsum_dolor_sit_amet_consectetur_adipiscing_elit_etiam_at_mi_vitae_augue_feugiat_scelerisque_in_a_eros), style= TextStyle(
                        fontSize = 14.sp,
            ...
            BottomBarItems(modifier = Modifier.align(BottomCenter)) {
    ...
    Column(modifier=modifier.fillMaxWidth())
    {
        ...
        Row (modifier = Modifier
            ...
            TextButton(onClick = {},
                ...
                border = BorderStroke(2.dp, LightGray_1)) {
            ...
            Button(onClick = onClick,
                ...
                elevation = ButtonDefaults.buttonElevation(0.dp)) {
                Text(text = stringResource(id = R.string.add_to_ba), style = TextStyle(
                    fontSize = 14.sp,
                    fontWeight = FontWeight.W400
                )
                )
...
fun RecommendedProducts(){
    ...
    {
        Text(text = stringResource(id = R.string.recommend_products), style = TextStyle(
            fontSize = 16.sp,
    ...
    Box(modifier = Modifier
        ...
        Row (modifier = Modifier.padding(all = 20.dp)){
            Column(modifier = Modifier.weight(1f)) {
                ...
                Spacer(modifier = Modifier.height(10.dp))
                Row{
                    Text(text = stringResource(id = R.string._98_reviews), style = TextStyle(
                        fontSize = 12.sp,
                        fontWeight = FontWeight.W400,
                        color = LightGray_1
                    ))
            ...
            Row {
                personIcons.forEachIndexed { index, i ->
                    Icon(painter = painterResource(id = i), contentDescription ="",
                        tint= Color.Unspecified,
                        modifier = Modifier
                            .size(32.dp)
                            .offset(
...
fun ProductHeaderSection(){
    ...
    Column(
        ...
        Text(text= stringResource(id = R.string.product_name), style = TextStyle(
            fontSize = 20.sp,
            fontWeight = FontWeight.W400,
            color = TextColor_1
        ))
